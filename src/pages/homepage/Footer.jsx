...
const Footer = () => {
  return(
    <>
      <footer className="bg-sky-50 text-slate-700 py-8 font-poppins">
  <div className="container px-10 mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    <div>
      ...
      <ul>
        <li className="mb-2">
          <a href="#" className="hover:underline">Tentang WellEat</a>
        </li>
        <li className="mb-2">
          <a href="#" className="hover:underline">Kebijakan WellEat</a>
        </li>
        <li className="mb-2">
    ...
    <div>
      ...
      <ul>
        <li className="mb-2">
          <a href="#" className="hover:underline">Informasi Resep</a>
        </li>
        <li className="mb-2">
          <a href="#" className="hover:underline">Detail Resep</a>
        </li>
        <li className="mb-2">
          <a href="#" className="hover:underline">Favorit Resep</a>
        </li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul>
        ...
        <li className="mb-2">
          <a href="#" className="hover:underline">Pemberitahuan</a>
        </li>
      </ul>
    </div>
